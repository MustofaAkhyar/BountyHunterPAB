            ...
            child: Padding(
              ...
              child: Form(
                child: Column(
                  ...
                  children: [
                    Text("Sign In", style: TextStyle(color: Colors.black, fontSize: 35, fontWeight: FontWeight.bold, fontFamily: 'Michroma')),
                    const SizedBox(
                      height: 40,
                    ),
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(fixedSize: const Size(120, 50),
                        backgroundColor: const Color.fromRGBO(245, 224, 187, 1),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(15),
                        ),
                      ),
                      onPressed: _signIn,
                      child: const Text('Sign in', style: TextStyle(color: Colors.grey, fontSize: 15, fontWeight: FontWeight.bold, fontFamily: 'Michroma'),),
                    ),
                      ...
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                            text: ' Daftar Disini',
                            style: const TextStyle(
                              color: Color.fromRGBO(120, 90, 11, 1),
                              fontSize: 16,
                            ),
